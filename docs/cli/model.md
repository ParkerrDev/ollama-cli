# Ollama CLI Model Selection (`/model` Command)

Select your Ollama CLI model. The `/model` command opens a dialog where you can
configure the model used by Ollama CLI, giving you more control over your
results.

## How to use the `/model` command

Use the following command in Ollama CLI:
