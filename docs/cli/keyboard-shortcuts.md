# Ollama CLI Keyboard Shortcuts

Ollama CLI ships with a set of default keyboard shortcuts for editing input,
...
| Toggle focus between the shell and Ollama input.                  | `Ctrl + F` |
