...
- **Workflow File**: `.github/workflows/ollama-automated-issue-triage.yml`
- **When it runs**: Immediately after an issue is created or reopened.
- **What it does**:
  - It uses a Ollama model to analyze the issue's title and body against a
...
- **Workflow File**: `.github/workflows/ollama-scheduled-pr-triage.yml`
...
- **Workflow File**: `.github/workflows/ollama-scheduled-issue-triage.yml`
- **When it runs**: Every hour on all open issues.
- **What it does**:
  - It actively seeks out issues that either have no labels at all or still have
    the `status/need-triage` label.
  - It then triggers the same powerful Ollama-based analysis as the initial
