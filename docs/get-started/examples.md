...
Not sure where to get started with Ollama CLI? This document covers examples on
how to use Ollama CLI for a variety of tasks.
...
Give Ollama the following prompt:

```cli
Rename the photos in my "photos" directory based on their contents.
```

Result: Ollama will ask for permission to rename your files.
...
Give Ollama CLI the following prompt:

```cli
Clone the 'chalk' repository from https://github.com/chalk/chalk, read its key source files, and explain how it works.
```

Result: Ollama will perform a sequence of actions to answer your request.
...
Ollama CLI will return an explanation based on the actual source code:
...
Result: Ollama CLI will read each file and then ask for permission to write a
new file. Provide your permission and Ollama CLI will provide the following
.csv:
...
Result: Ollama CLI will ask for permission to write a new file and create a test
for your login page
