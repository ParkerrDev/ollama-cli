...
Ollama API. The `google_web_search` tool returns a summary of web results with
sources.
...
## How to use `google_web_search` with the Ollama CLI

The `google_web_search` tool sends a query to the Ollama API, which then
