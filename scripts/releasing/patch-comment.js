...
async function main() {
  ...
  const repo = {
    owner: process.env.GITHUB_REPOSITORY_OWNER || 'google-ollama',
    repo: process.env.GITHUB_REPOSITORY_NAME || 'ollama-cli',
  };
...
- **NPM Package**: \`npm install @google/ollama-cli@${npmTag}\`
