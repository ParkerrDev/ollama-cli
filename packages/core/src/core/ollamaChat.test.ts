...
describe('OllamaChat', () => {
  ...
  beforeEach(() => {
    ...
    chat = new OllamaChat(mockConfig, config, []);
  });
  ...
  describe('constructor', () => {
    it('should initialize lastPromptTokenCount based on history size', () => {
      ...
      const chatWithHistory = new OllamaChat(mockConfig, config, history);
    ...
    it('should initialize lastPromptTokenCount for empty history', () => {
      const chatEmpty = new OllamaChat(mockConfig, config, []);
  ...
  describe('Model Resolution', () => {
    ...
    it('should use the FLASH model when in fallback mode (sendMessageStream)', async () => {
      vi.mocked(mockConfig.getModel).mockReturnValue('ollama-pro');
