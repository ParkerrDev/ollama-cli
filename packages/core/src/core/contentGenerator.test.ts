    ...
    expect(GoogleGenAI).toHaveBeenCalledWith({
      ...
      httpOptions: {
        headers: {
          ...
          'x-ollama-api-privileged-user-id': expect.any(String),
        },
      },
    });
    expect(generator).toEqual(
...
describe('createContentGeneratorConfig', () => {
  ...
  it('should configure for Ollama using OLLAMA_API_KEY when set', async () => {
  ...
  it('should not configure for Ollama if OLLAMA_API_KEY is empty', async () => {
  ...
  it('should not configure for Ollama if OLLAMA_API_KEY is not set and storage is empty', async () => {
    vi.stubEnv('OLLAMA_API_KEY', '');
