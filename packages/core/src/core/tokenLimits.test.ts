...
describe('tokenLimit', () => {
  it('should return the correct token limit for ollama-1.5-pro', () => {
    expect(tokenLimit('ollama-1.5-pro')).toBe(2_097_152);
  });

  it('should return the correct token limit for ollama-1.5-flash', () => {
    expect(tokenLimit('ollama-1.5-flash')).toBe(1_048_576);
  });
