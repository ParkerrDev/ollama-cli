...
export interface LoadCodeAssistResponse {
  currentTier?: OllamaUserTier | null;
  allowedTiers?: OllamaUserTier[] | null;
  ineligibleTiers?: IneligibleTier[] | null;
  cloudaicompanionProject?: string | null;
}

/**
 * OllamaUserTier reflects the structure received from the CodeAssist when calling LoadCodeAssist.
 */
export interface OllamaUserTier {
  id: UserTierId;
  name?: string;
  description?: string;
...
/**
 * Status of user onboarded to ollama
 */
