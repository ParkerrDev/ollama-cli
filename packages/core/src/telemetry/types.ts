...
export const EVENT_CLI_CONFIG = 'ollama_cli.config';
export class StartSessionEvent implements BaseTelemetryEvent {
  ...
  constructor(config: Config, toolRegistry?: ToolRegistry) {
    ...
    this.api_key_enabled = useOllama || useVertex;
...
export const EVENT_USER_PROMPT = 'ollama_cli.user_prompt';
...
export const EVENT_TOOL_CALL = 'ollama_cli.tool_call';
...
export const EVENT_API_REQUEST = 'ollama_cli.api_request';
...
export const EVENT_API_ERROR = 'ollama_cli.api_error';
...
export const EVENT_API_RESPONSE = 'ollama_cli.api_response';
...
export const EVENT_FLASH_FALLBACK = 'ollama_cli.flash_fallback';
...
export const EVENT_RIPGREP_FALLBACK = 'ollama_cli.ripgrep_fallback';
...
export const EVENT_NEXT_SPEAKER_CHECK = 'ollama_cli.next_speaker_check';
...
export const EVENT_SLASH_COMMAND = 'ollama_cli.slash_command';
...
export const EVENT_CHAT_COMPRESSION = 'ollama_cli.chat_compression';
...
export const EVENT_MALFORMED_JSON_RESPONSE =
  'ollama_cli.malformed_json_response';
...
export const EVENT_IDE_CONNECTION = 'ollama_cli.ide_connection';
...
export const EVENT_CONVERSATION_FINISHED = 'ollama_cli.conversation_finished';
...
export const EVENT_FILE_OPERATION = 'ollama_cli.file_operation';
...
export const EVENT_INVALID_CHUNK = 'ollama_cli.chat.invalid_chunk';
...
export const EVENT_CONTENT_RETRY = 'ollama_cli.chat.content_retry';
...
export const EVENT_CONTENT_RETRY_FAILURE =
  'ollama_cli.chat.content_retry_failure';
...
export const EVENT_MODEL_ROUTING = 'ollama_cli.model_routing';
...
export const EVENT_EXTENSION_INSTALL = 'ollama_cli.extension_install';
...
export const EVENT_TOOL_OUTPUT_TRUNCATED = 'ollama_cli.tool_output_truncated';
...
export const EVENT_EXTENSION_UNINSTALL = 'ollama_cli.extension_uninstall';
...
export const EVENT_EXTENSION_UPDATE = 'ollama_cli.extension_update';
...
export const EVENT_EXTENSION_ENABLE = 'ollama_cli.extension_enable';
...
export const EVENT_MODEL_SLASH_COMMAND = 'ollama_cli.slash_command.model';
...
export const EVENT_LLM_LOOP_CHECK = 'ollama_cli.llm_loop_check';
...
export const EVENT_EXTENSION_DISABLE = 'ollama_cli.extension_disable';
...
export const EVENT_SMART_EDIT_STRATEGY = 'ollama_cli.smart_edit_strategy';
...
export const EVENT_SMART_EDIT_CORRECTION = 'ollama_cli.smart_edit_correction';
...
export const EVENT_AGENT_START = 'ollama_cli.agent.start';
...
export const EVENT_AGENT_FINISH = 'ollama_cli.agent.finish';
...
export const EVENT_AGENT_RECOVERY_ATTEMPT = 'ollama_cli.agent.recovery_attempt';
...
export const EVENT_WEB_FETCH_FALLBACK_ATTEMPT =
  'ollama_cli.web_fetch_fallback_attempt';
