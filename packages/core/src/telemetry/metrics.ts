...
const EVENT_CHAT_COMPRESSION = 'ollama_cli.chat_compression';
const TOOL_CALL_COUNT = 'ollama_cli.tool.call.count';
const TOOL_CALL_LATENCY = 'ollama_cli.tool.call.latency';
const API_REQUEST_COUNT = 'ollama_cli.api.request.count';
const API_REQUEST_LATENCY = 'ollama_cli.api.request.latency';
const TOKEN_USAGE = 'ollama_cli.token.usage';
const SESSION_COUNT = 'ollama_cli.session.count';
const FILE_OPERATION_COUNT = 'ollama_cli.file.operation.count';
const LINES_CHANGED = 'ollama_cli.lines.changed';
const INVALID_CHUNK_COUNT = 'ollama_cli.chat.invalid_chunk.count';
const CONTENT_RETRY_COUNT = 'ollama_cli.chat.content_retry.count';
const CONTENT_RETRY_FAILURE_COUNT =
  'ollama_cli.chat.content_retry_failure.count';
const MODEL_ROUTING_LATENCY = 'ollama_cli.model_routing.latency';
const MODEL_ROUTING_FAILURE_COUNT = 'ollama_cli.model_routing.failure.count';
const MODEL_SLASH_COMMAND_CALL_COUNT =
  'ollama_cli.slash_command.model.call_count';

// Agent Metrics
const AGENT_RUN_COUNT = 'ollama_cli.agent.run.count';
const AGENT_DURATION_MS = 'ollama_cli.agent.duration';
const AGENT_TURNS = 'ollama_cli.agent.turns';
const AGENT_RECOVERY_ATTEMPT_COUNT = 'ollama_cli.agent.recovery_attempt.count';
const AGENT_RECOVERY_ATTEMPT_DURATION =
  'ollama_cli.agent.recovery_attempt.duration';
...
const STARTUP_TIME = 'ollama_cli.startup.duration';
const MEMORY_USAGE = 'ollama_cli.memory.usage';
const CPU_USAGE = 'ollama_cli.cpu.usage';
const TOOL_QUEUE_DEPTH = 'ollama_cli.tool.queue.depth';
const TOOL_EXECUTION_BREAKDOWN = 'ollama_cli.tool.execution.breakdown';
const TOKEN_EFFICIENCY = 'ollama_cli.token.efficiency';
const API_REQUEST_BREAKDOWN = 'ollama_cli.api.request.breakdown';
const PERFORMANCE_SCORE = 'ollama_cli.performance.score';
const REGRESSION_DETECTION = 'ollama_cli.performance.regression';
const REGRESSION_PERCENTAGE_CHANGE =
  'ollama_cli.performance.regression.percentage_change';
const BASELINE_COMPARISON = 'ollama_cli.performance.baseline.comparison';
const FLICKER_FRAME_COUNT = 'ollama_cli.ui.flicker.count';
const SLOW_RENDER_LATENCY = 'ollama_cli.ui.slow_render.latency';
const EXIT_FAIL_COUNT = 'ollama_cli.exit.fail.count';
