...
export interface EventValue {
  ollama_cli_key: EventMetadataKey;
  value: string;
}

export interface LogEvent {
  console_type: 'OLLAMA_CLI';
  application: number;
  event_name: string;
 ...
 * distribution channel in which the user is using Ollama CLI.  Ollama CLI comes bundled
...
export class ClearcutLogger {
  ...
  createBasicLogEvent(
    ...
    return {
      console_type: 'OLLAMA_CLI',
      application: 102, // OLLAMA_CLI
      event_name: eventName as string,
      event_metadata: [
        [
          ...data,
          {
            ollama_cli_key: EventMetadataKey.OLLAMA_CLI_SURFACE,
            value: surface,
          },
          {
            ollama_cli_key: EventMetadataKey.OLLAMA_CLI_VERSION,
            value: CLI_VERSION,
          },
          {
            ollama_cli_key: EventMetadataKey.OLLAMA_CLI_GIT_COMMIT_HASH,
            value: GIT_COMMIT_INFO,
          },
          {
            ollama_cli_key: EventMetadataKey.OLLAMA_CLI_OS,
  ...
  logStartSessionEvent(event: StartSessionEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_START_SESSION_MODEL,
        value: event.model,
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_START_SESSION_EMBEDDING_MODEL,
        value: event.embedding_model,
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_START_SESSION_SANDBOX,
        value: event.sandbox_enabled.toString(),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_START_SESSION_CORE_TOOLS,
        value: event.core_tools_enabled,
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_START_SESSION_APPROVAL_MODE,
        value: event.approval_mode,
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_START_SESSION_API_KEY_ENABLED,
        value: event.api_key_enabled.toString(),
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_START_SESSION_VERTEX_API_ENABLED,
        value: event.vertex_ai_enabled.toString(),
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_START_SESSION_DEBUG_MODE_ENABLED,
      ...
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_START_SESSION_MCP_SERVERS,
      ...
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_START_SESSION_TELEMETRY_ENABLED,
        value: event.telemetry_enabled.toString(),
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_START_SESSION_TELEMETRY_LOG_USER_PROMPTS_ENABLED,
        value: event.telemetry_log_user_prompts_enabled.toString(),
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_START_SESSION_MCP_SERVERS_COUNT,
      ...
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_START_SESSION_MCP_TOOLS_COUNT,
        value: event.mcp_tools_count?.toString() ?? '',
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_START_SESSION_MCP_TOOLS,
        value: event.mcp_tools ? event.mcp_tools : '',
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_START_SESSION_EXTENSIONS_COUNT,
        value: event.extensions_count.toString(),
      },
      // We deliberately do not log the names of extensions here, to be safe.
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_START_SESSION_EXTENSION_IDS,
  ...
  logNewPromptEvent(event: UserPromptEvent): void {
    ...
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_USER_PROMPT_LENGTH,
  ...
  logToolCallEvent(event: ToolCallEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_TOOL_CALL_NAME,
        value: JSON.stringify(event.function_name),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_TOOL_CALL_DECISION,
        value: JSON.stringify(event.decision),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_TOOL_CALL_SUCCESS,
        value: JSON.stringify(event.success),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_TOOL_CALL_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_TOOL_CALL_ERROR_TYPE,
        value: JSON.stringify(event.error_type),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_TOOL_TYPE,
        value: JSON.stringify(event.tool_type),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_TOOL_CALL_CONTENT_LENGTH,
        value: JSON.stringify(event.content_length),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_TOOL_CALL_MCP_SERVER_NAME,
    ...
    if (event.metadata) {
      const metadataMapping: { [key: string]: EventMetadataKey } = {
        model_added_lines: EventMetadataKey.OLLAMA_CLI_AI_ADDED_LINES,
        model_removed_lines: EventMetadataKey.OLLAMA_CLI_AI_REMOVED_LINES,
        model_added_chars: EventMetadataKey.OLLAMA_CLI_AI_ADDED_CHARS,
        model_removed_chars: EventMetadataKey.OLLAMA_CLI_AI_REMOVED_CHARS,
        user_added_lines: EventMetadataKey.OLLAMA_CLI_USER_ADDED_LINES,
        user_removed_lines: EventMetadataKey.OLLAMA_CLI_USER_REMOVED_LINES,
        user_added_chars: EventMetadataKey.OLLAMA_CLI_USER_ADDED_CHARS,
        user_removed_chars: EventMetadataKey.OLLAMA_CLI_USER_REMOVED_CHARS,
      };

      for (const [key, ollama_cli_key] of Object.entries(metadataMapping)) {
    ...
    if (event.extension_id) {
      data.push({
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_EXTENSION_ID,
  ...
  logFileOperationEvent(event: FileOperationEvent): void {
    const data: EventValue[] = [
      ...
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_FILE_OPERATION_TYPE,
        value: JSON.stringify(event.operation),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_FILE_OPERATION_LINES,
        value: JSON.stringify(event.lines),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_FILE_OPERATION_MIMETYPE,
        value: JSON.stringify(event.mimetype),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_FILE_OPERATION_EXTENSION,
    ...
    if (event.programming_language) {
      data.push({
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_PROGRAMMING_LANGUAGE,
  ...
  logApiRequestEvent(event: ApiRequestEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_API_REQUEST_MODEL,
  ...
  logApiResponseEvent(event: ApiResponseEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_API_RESPONSE_MODEL,
        value: JSON.stringify(event.model),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_API_RESPONSE_STATUS_CODE,
        value: JSON.stringify(event.status_code),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_API_RESPONSE_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_API_RESPONSE_INPUT_TOKEN_COUNT,
        value: JSON.stringify(event.usage.input_token_count),
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_API_RESPONSE_OUTPUT_TOKEN_COUNT,
        value: JSON.stringify(event.usage.output_token_count),
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_API_RESPONSE_CACHED_TOKEN_COUNT,
        value: JSON.stringify(event.usage.cached_content_token_count),
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_API_RESPONSE_THINKING_TOKEN_COUNT,
        value: JSON.stringify(event.usage.thoughts_token_count),
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_API_RESPONSE_TOOL_TOKEN_COUNT,
  ...
  logApiErrorEvent(event: ApiErrorEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_API_ERROR_MODEL,
        value: JSON.stringify(event.model),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_API_ERROR_TYPE,
        value: JSON.stringify(event.error_type),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_API_ERROR_STATUS_CODE,
        value: JSON.stringify(event.status_code),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_API_ERROR_DURATION_MS,
        value: JSON.stringify(event.duration_ms),
      },
    ];
  ...
  logChatCompressionEvent(event: ChatCompressionEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_COMPRESSION_TOKENS_BEFORE,
        value: `${event.tokens_before}`,
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_COMPRESSION_TOKENS_AFTER,
  ...
  logLoopDetectedEvent(event: LoopDetectedEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_LOOP_DETECTED_TYPE,
    ...
    if (event.confirmed_by_model) {
      data.push({
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_LOOP_DETECTED_CONFIRMED_BY_MODEL,
  ...
  logNextSpeakerCheck(event: NextSpeakerCheckEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_RESPONSE_FINISH_REASON,
        value: JSON.stringify(event.finish_reason),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_NEXT_SPEAKER_CHECK_RESULT,
  ...
  logSlashCommandEvent(event: SlashCommandEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_SLASH_COMMAND_NAME,
    ...
    if (event.subcommand) {
      data.push({
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_SLASH_COMMAND_SUBCOMMAND,
    ...
    if (event.status) {
      data.push({
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_SLASH_COMMAND_STATUS,
  ...
  logMalformedJsonResponseEvent(event: MalformedJsonResponseEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_MALFORMED_JSON_RESPONSE_MODEL,
        value: JSON.stringify(event.model),
      },
    ];
  ...
  logIdeConnectionEvent(event: IdeConnectionEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_IDE_CONNECTION_TYPE,
  ...
  logConversationFinishedEvent(event: ConversationFinishedEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_SESSION_ID,
        value: this.config?.getSessionId() ?? '',
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_CONVERSATION_TURN_COUNT,
        value: JSON.stringify(event.turnCount),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_APPROVAL_MODE,
  ...
  logInvalidChunkEvent(event: InvalidChunkEvent): void {
    ...
    if (event.error_message) {
      data.push({
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_INVALID_CHUNK_ERROR_MESSAGE,
  ...
  logContentRetryEvent(event: ContentRetryEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_CONTENT_RETRY_ATTEMPT_NUMBER,
        value: String(event.attempt_number),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_CONTENT_RETRY_ERROR_TYPE,
        value: event.error_type,
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_CONTENT_RETRY_DELAY_MS,
  ...
  logContentRetryFailureEvent(event: ContentRetryFailureEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_CONTENT_RETRY_FAILURE_TOTAL_ATTEMPTS,
        value: String(event.total_attempts),
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_CONTENT_RETRY_FAILURE_FINAL_ERROR_TYPE,
    ...
    if (event.total_duration_ms) {
      data.push({
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_CONTENT_RETRY_FAILURE_TOTAL_DURATION_MS,
  ...
  async logExtensionInstallEvent(event: ExtensionInstallEvent): Promise<void> {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_EXTENSION_NAME,
      ...
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_EXTENSION_VERSION,
        value: event.extension_version,
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_EXTENSION_SOURCE,
        value: event.extension_source,
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_EXTENSION_INSTALL_STATUS,
        value: event.status,
      },
    ];
  ...
  async logExtensionUninstallEvent(
    ...
    const data: EventValue[] = [
      ...
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_EXTENSION_UNINSTALL_STATUS,
        value: event.status,
      },
    ];
  ...
  async logExtensionUpdateEvent(event: ExtensionUpdateEvent): Promise<void> {
    const data: EventValue[] = [
      ...
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_EXTENSION_PREVIOUS_VERSION,
      ...
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_EXTENSION_UPDATE_STATUS,
        value: event.status,
      },
    ];
  ...
  logToolOutputTruncatedEvent(event: ToolOutputTruncatedEvent): void {
    const data: EventValue[] = [
      ...
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_TOOL_OUTPUT_TRUNCATED_ORIGINAL_LENGTH,
        value: JSON.stringify(event.original_content_length),
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_TOOL_OUTPUT_TRUNCATED_TRUNCATED_LENGTH,
        value: JSON.stringify(event.truncated_content_length),
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_TOOL_OUTPUT_TRUNCATED_THRESHOLD,
        value: JSON.stringify(event.threshold),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_TOOL_OUTPUT_TRUNCATED_LINES,
        value: JSON.stringify(event.lines),
      },
    ];
  ...
  logModelRoutingEvent(event: ModelRoutingEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_ROUTING_DECISION,
        value: event.decision_model,
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_ROUTING_DECISION_SOURCE,
        value: event.decision_source,
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_ROUTING_LATENCY_MS,
        value: event.routing_latency_ms.toString(),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_ROUTING_FAILURE,
    ...
    if (event.error_message) {
      data.push({
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_ROUTING_FAILURE_REASON,
        value: event.error_message,
      });
    }
  ...
  async logExtensionEnableEvent(event: ExtensionEnableEvent): Promise<void> {
    const data: EventValue[] = [
      ...
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_EXTENSION_ENABLE_SETTING_SCOPE,
  ...
  logModelSlashCommandEvent(event: ModelSlashCommandEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_MODEL_SLASH_COMMAND,
  ...
  async logExtensionDisableEvent(event: ExtensionDisableEvent): Promise<void> {
    const data: EventValue[] = [
      ...
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_EXTENSION_DISABLE_SETTING_SCOPE,
        value: event.setting_scope,
      },
    ];
  ...
  logSmartEditStrategyEvent(event: SmartEditStrategyEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_SMART_EDIT_STRATEGY,
  ...
  logSmartEditCorrectionEvent(event: SmartEditCorrectionEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_SMART_EDIT_CORRECTION,
  ...
  logAgentStartEvent(event: AgentStartEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_AGENT_ID,
        value: event.agent_id,
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_AGENT_NAME,
  ...
  logAgentFinishEvent(event: AgentFinishEvent): void {
    const data: EventValue[] = [
      ...
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_AGENT_DURATION_MS,
        value: event.duration_ms.toString(),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_AGENT_TURN_COUNT,
        value: event.turn_count.toString(),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_AGENT_TERMINATE_REASON,
  ...
  logRecoveryAttemptEvent(event: RecoveryAttemptEvent): void {
    const data: EventValue[] = [
      ...
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_AGENT_RECOVERY_REASON,
        value: event.reason,
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_AGENT_RECOVERY_DURATION_MS,
        value: event.duration_ms.toString(),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_AGENT_RECOVERY_SUCCESS,
  ...
  logWebFetchFallbackAttemptEvent(event: WebFetchFallbackAttemptEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_WEB_FETCH_FALLBACK_REASON,
        value: event.reason,
      },
    ];
  ...
  logLlmLoopCheckEvent(event: LlmLoopCheckEvent): void {
    const data: EventValue[] = [
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_PROMPT_ID,
        value: event.prompt_id,
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_LLM_LOOP_CHECK_FLASH_CONFIDENCE,
        value: event.flash_confidence.toString(),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_LLM_LOOP_CHECK_MAIN_MODEL,
        value: event.main_model,
      },
      {
        ollama_cli_key:
          EventMetadataKey.OLLAMA_CLI_LLM_LOOP_CHECK_MAIN_MODEL_CONFIDENCE,
  ...
  addDefaultFields(data: EventValue[], totalAccounts: number): EventValue[] {
    const defaultLogMetadata: EventValue[] = [
      ...
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_AUTH_TYPE,
        value: JSON.stringify(
          this.config?.getContentGeneratorConfig()?.authType,
        ),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_GOOGLE_ACCOUNTS_COUNT,
        value: `${totalAccounts}`,
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_PROMPT_ID,
      ...
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_NODE_VERSION,
        value: process.versions.node,
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_USER_SETTINGS,
        value: this.getConfigJson(),
      },
      {
        ollama_cli_key: EventMetadataKey.OLLAMA_CLI_INTERACTIVE,
