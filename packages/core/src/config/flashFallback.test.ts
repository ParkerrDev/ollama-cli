...
import { DEFAULT_OLLAMA_MODEL, DEFAULT_OLLAMA_FLASH_MODEL } from './models.js';
...
describe('Flash Model Fallback Configuration', () => {
  ...
  describe('setModel', () => {
    it('should only mark as switched if contentGeneratorConfig exists', () => {
      ...
      newConfig.setModel(DEFAULT_OLLAMA_FLASH_MODEL);
  ...
  describe('getModel', () => {
    it('should return contentGeneratorConfig model if available', () => {
      ...
      config.setModel(DEFAULT_OLLAMA_FLASH_MODEL);
      expect(config.getModel()).toBe(DEFAULT_OLLAMA_FLASH_MODEL);
    });
