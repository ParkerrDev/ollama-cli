...
<example>
User request: Create a website with a React for creating fancy logos using ollama-2.5-flash-image
...
4. Create an API service module within the React app (using "fetch" or "axios") to securely format and send the prompt data via an HTTP POST request to the specified "ollama-2.5-flash-image" (Ollama model) endpoint.
