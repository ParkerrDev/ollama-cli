...
export interface ReadManyFilesParams {
  ...
  /**
   * Whether to respect .gitignore and .ollamaignore patterns (optional, defaults to true)
   */
  file_filtering_options?: {
    respect_git_ignore?: boolean;
    respect_ollama_ignore?: boolean;
  };
}
 ...
 * This combines the shared patterns with dynamic patterns like OLLAMA.md.
    ...
    try {
      ...
      const { filteredPaths, ignoredCount } =
        fileDiscovery.filterFilesWithReport(relativeEntries, {
          ...
          respectOllamaIgnore:
            this.params.file_filtering_options?.respect_ollama_ignore ??
            this.config.getFileFilteringOptions().respectOllamaIgnore ??
  ...
  constructor(
    ...
    const parameterSchema = {
      ...
      properties: {
        ...
        file_filtering_options: {
          description:
            'Whether to respect ignore patterns from .gitignore or .ollamaignore',
          type: 'object',
          properties: {
            respect_git_ignore: {
              description:
            ...
            respect_ollama_ignore: {
              description:
                'Optional: Whether to respect .ollamaignore patterns when listing files. Defaults to true.',
              type: 'boolean',
            },
          },
        },
