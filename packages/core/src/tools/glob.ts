...
export interface GlobToolParams {
  ...
  /**
   * Whether to respect .ollamaignore patterns (optional, defaults to true)
   */
    ...
    try {
      ...
      const { filteredPaths, ignoredCount } =
        fileDiscovery.filterFilesWithReport(relativePaths, {
          ...
          respectOllamaIgnore:
            this.params?.respect_ollama_ignore ??
      ...
      Kind.Search,
      {
        properties: {
          ...
          respect_ollama_ignore: {
            description:
              'Optional: Whether to respect .ollamaignore patterns when finding files. Defaults to true.',
            type: 'boolean',
          },
        },
        required: ['pattern'],
