...
// Mock OllamaClient and Config constructor
...
describe('WebSearchTool', () => {
  ...
  beforeEach(() => {
    ...
    mockOllamaClient = new OllamaClient(mockConfigInstance);
  ...
  describe('execute', () => {
    it('should return search results for a successful query', async () => {
      ...
      (mockOllamaClient.generateContent as Mock).mockResolvedValue({
        candidates: [
          {
            content: {
              role: 'model',
    ...
    it('should return a WEB_SEARCH_FAILED error on failure', async () => {
      ...
      (mockOllamaClient.generateContent as Mock).mockRejectedValue(testError);
        ...
        candidates: [
          {
            ...
            groundingMetadata: {
              groundingChunks: [
                ...
                {
                  web: {
                    title: 'google-ollama/ollama-cli',
                    uri: 'https://github.com/google-ollama/ollama-cli',
                  },
                },
                {
                  web: {
                    title: 'Ollama CLI: your open-source AI agent',
                    uri: 'https://blog.google/technology/developers/introducing-ollama-cli-open-source-ai-agent/',
                  },
                },
              ],
              groundingSupports: [
                ...
                {
                  segment: {
                    // Byte range of "Ollama CLI✨️" (utf-8 encoded)
                    startIndex: 17,
                    endIndex: 33,
                  },
...
こんにちは![1] Ollama CLI✨️[2][3]

Sources:
[1] Japanese Greeting (https://example.test/japanese-greeting)
[2] google-ollama/ollama-cli (https://github.com/google-ollama/ollama-cli)
[3] Ollama CLI: your open-source AI agent (https://blog.google/technology/developers/introducing-ollama-cli-open-source-ai-agent/)`;
