...
import { type Config, type ResumedSessionData } from '@google/ollama-cli-core';
...
describe('ollama.tsx main function', () => {
  let originalEnvOllamaSandbox: string | undefined;
  ...
  beforeEach(() => {
    ...
    originalEnvOllamaSandbox = process.env['OLLAMA_SANDBOX'];
    originalEnvSandbox = process.env['SANDBOX'];
    delete process.env['OLLAMA_SANDBOX'];
  ...
  afterEach(() => {
    ...
    if (originalEnvOllamaSandbox !== undefined) {
      process.env['OLLAMA_SANDBOX'] = originalEnvOllamaSandbox;
    } else {
      delete process.env['OLLAMA_SANDBOX'];
    }
...
describe('ollama.tsx main function kitty protocol', () => {
  ...
  beforeEach(() => {
    ...
    originalEnvNoRelaunch = process.env['OLLAMA_CLI_NO_RELAUNCH'];
    process.env['OLLAMA_CLI_NO_RELAUNCH'] = 'true';
  ...
  afterEach(() => {
    ...
    if (originalEnvNoRelaunch !== undefined) {
      process.env['OLLAMA_CLI_NO_RELAUNCH'] = originalEnvNoRelaunch;
    } else {
      delete process.env['OLLAMA_CLI_NO_RELAUNCH'];
    }
    vi.restoreAllMocks();
  });
...
describe('startInteractiveUI', () => {
  ...
  it('should not recordSlowRender when less than threshold', async () => {
    const { recordSlowRender } = await import('@google/ollama-cli-core');
