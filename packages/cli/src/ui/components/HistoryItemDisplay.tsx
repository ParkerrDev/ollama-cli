...
import { getMCPServerStatus } from '@google/ollama-cli-core';
...
interface HistoryItemDisplayProps {
  ...
  availableTerminalHeightOllama?: number;
}
    ...
    <Box flexDirection="column" key={itemForDisplay.id} width={terminalWidth}>
      ...
      {itemForDisplay.type === 'ollama' && (
        <OllamaMessage
          ...
          isPending={isPending}
          availableTerminalHeight={
            availableTerminalHeightOllama ?? availableTerminalHeight
          }
