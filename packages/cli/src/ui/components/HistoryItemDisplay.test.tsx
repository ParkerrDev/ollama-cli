...
describe('<HistoryItemDisplay />', () => {
  ...
  it('renders AboutBox for "about" type', () => {
    ...
    expect(lastFrame()).toContain('About Ollama CLI');
  });
  ...
  describe.each([true, false])(
    'ollama items (alternateBuffer=%s)',
    (useAlternateBuffer) => {
      const longCode =
        '# Example code block:\n' +
        '```python\n' +
      ...
      it('should render a truncated ollama item', () => {
        const item: HistoryItem = {
          id: 1,
          type: 'ollama',
          text: longCode,
      ...
      it('should render a full ollama item when using availableTerminalHeightOllama', () => {
        const item: HistoryItem = {
          id: 1,
          type: 'ollama',
          text: longCode,
        ...
        const { lastFrame } = renderWithProviders(
          <HistoryItemDisplay
            ...
            terminalWidth={80}
            availableTerminalHeight={10}
            availableTerminalHeightOllama={Number.MAX_SAFE_INTEGER}
          />,
          { useAlternateBuffer },
        );
      ...
      it('should render a truncated ollama_content item', () => {
        const item: HistoryItem = {
          id: 1,
          type: 'ollama_content',
          text: longCode,
      ...
      it('should render a full ollama_content item when using availableTerminalHeightOllama', () => {
        const item: HistoryItem = {
          id: 1,
          type: 'ollama_content',
          text: longCode,
