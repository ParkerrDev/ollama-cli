...
export const initCommand: SlashCommand = {
  ...
  action: async (
    ...
    return {
      type: 'submit_prompt',
      content: `
You are an AI agent that brings the power of Ollama directly into the terminal. Your task is to analyze the current directory and generate a comprehensive OLLAMA.md file to be used as instructional context for future interactions.
...
Write the complete content to the \`OLLAMA.md\` file. The output must be well-formatted Markdown.
`,
    };
  },
};
