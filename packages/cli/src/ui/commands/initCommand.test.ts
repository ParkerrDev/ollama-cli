...
describe('initCommand', () => {
  ...
  it('should inform the user if OLLAMA.md already exists', async () => {
  ...
  it('should create OLLAMA.md and submit a prompt if it does not exist', async () => {
    ...
    expect(fs.writeFileSync).toHaveBeenCalledWith(ollamaMdPath, '', 'utf8');
    ...
    expect(result.content).toContain(
      'You are an AI agent that brings the power of Ollama',
    );
  });
