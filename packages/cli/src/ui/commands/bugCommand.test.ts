...
describe('bugCommand', () => {
  beforeEach(() => {
    ...
    vi.stubEnv('SANDBOX', 'ollama-test');
  });
...
* **Model Version:** ollama-pro
* **Memory Usage:** 100 MB
* **IDE Client:** VSCode
`;
    const expectedUrl =
      'https://github.com/google-ollama/ollama-cli/issues/new?template=bug_report.yml&title=A%20test%20bug&info=' +
