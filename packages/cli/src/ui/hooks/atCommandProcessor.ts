...
import type { AnyToolInvocation, Config } from '@google/ollama-cli-core';
import {
  debugLogger,
  getErrorMessage,
  isNodeError,
...
export async function handleAtCommand({
  ...
  for (const atPathPart of atPathCommandParts) {
    ...
    const ollamaIgnored =
      respectFileIgnore.respectOllamaIgnore &&
      fileDiscovery.shouldIgnoreFile(pathName, {
  ...
  const toolArgs = {
    ...
    file_filtering_options: {
      ...
      respect_ollama_ignore: respectFileIgnore.respectOllamaIgnore,
    },
