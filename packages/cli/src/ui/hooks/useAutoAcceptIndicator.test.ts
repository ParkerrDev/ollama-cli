...
import { Config, ApprovalMode } from '@google/ollama-cli-core';
import type { Config as ActualConfigType } from '@google/ollama-cli-core';
...
interface MockConfigInstanceShape {
  ...
  getOllamaMdFileCount: Mock<() => number>;
  ...
  beforeEach(() => {
    ...
    (
      ...
      const instance: MockConfigInstanceShape = {
        ...
        getOllamaMdFileCount: vi.fn().mockReturnValue(0) as Mock<() => number>,
        getToolRegistry: vi
          .fn()
