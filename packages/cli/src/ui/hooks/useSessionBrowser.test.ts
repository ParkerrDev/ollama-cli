...
import type { MessageRecord } from '@google/ollama-cli-core';
...
describe('convertSessionToHistoryFormats', () => {
  ...
  it('should convert basic user and ollama messages', () => {
  ...
  describe('tool calls in client history', () => {
    it('should convert tool calls to correct Ollama client history format', () => {
      const messages: MessageRecord[] = [
        {
          id: 'msg-1',
          timestamp: '2025-01-01T00:01:00Z',
