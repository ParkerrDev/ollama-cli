...
export const INFORMATIVE_TIPS = [
  ...
  'Choose a specific Ollama model for conversations (/settings)...',
  ...
  'Toggle respect for .ollamaignore files in context (/settings)...',
  ...
  'Submit your prompt to Ollama with Enter...',
