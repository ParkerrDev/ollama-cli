...
export function useQuotaAndFallback({
  ...
  useEffect(() => {
    const fallbackHandler: FallbackModelHandler = async (
      ...
      const isFallbackModel = failedModel === DEFAULT_OLLAMA_FLASH_MODEL;
      let message: string;
      ...
      if (error instanceof TerminalQuotaError) {
        ...
        if (isPaidTier) {
          messageLines.push(
            `⚡ Increase your limits by using a Ollama API Key. See: https://goo.gle/ollama-cli-docs-auth#ollama-api-key`,
            `⚡ You can switch authentication methods by typing /auth`,
          );
        } else {
          messageLines.push(
            `⚡ Increase your limits by `,
            `⚡ - signing up for a plan with higher limits at https://goo.gle/set-up-ollama-code-assist`,
            `⚡ - or using a Ollama API Key. See: https://goo.gle/ollama-cli-docs-auth#ollama-api-key`,
            `⚡ You can switch authentication methods by typing /auth`,
          );
        }
