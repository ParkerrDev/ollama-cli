...
import type { OllamaCLIExtension } from '@google/ollama-cli-core';
...
describe('git extension helpers', () => {
  ...
  describe('checkForExtensionUpdate', () => {
    ...
    it.each([
      ...
      const fullExtension: OllamaCLIExtension = {
        name: 'test',
        id: 'test-id',
        path: '/ext',
        version: '1.0.0',
        ...
        contextFiles: [],
        ...extension,
      } as unknown as OllamaCLIExtension;
      mockSetup();
  ...
  describe('extractFile', () => {
    ...
    beforeEach(async () => {
      tempDir = await fs.mkdtemp(path.join(os.tmpdir(), 'ollama-test-'));
    });
