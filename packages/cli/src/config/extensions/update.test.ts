...
import { OLLAMA_DIR, KeychainTokenStorage } from '@google/ollama-cli-core';
...
describe('update tests', () => {
  ...
  beforeEach(() => {
    ...
    userExtensionsDir = path.join(tempHomeDir, OLLAMA_DIR, 'extensions');
  ...
  describe('updateExtension', () => {
    it('should update a git-installed extension', async () => {
      const gitUrl = 'https://github.com/google/ollama-extensions.git';
      const extensionName = 'ollama-extensions';
