  ...
  ui: {
    ...
    properties: {
      ...
      showStatusInTitle: {
        ...
        default: false,
        description:
          'Show Ollama CLI status and thoughts in the terminal window title',
        showInDialog: true,
      },
      hideTips: {
        type: 'boolean',
      ...
      hideContextSummary: {
        ...
        default: false,
        description:
          'Hide the context summary (OLLAMA.md, MCP servers) above the input.',
        showInDialog: true,
      },
      footer: {
        type: 'object',
  ...
  context: {
    ...
    properties: {
      ...
      loadMemoryFromIncludeDirectories: {
        ...
        default: false,
        description: oneLine`
          Controls how /memory refresh loads OLLAMA.md files.
  ...
  tools: {
    ...
    properties: {
      ...
      enableHooks: {
        ...
        default: false,
        description:
          'Enable the hooks system for intercepting and customizing Ollama CLI behavior. When enabled, hooks configured in settings will execute at appropriate lifecycle events (BeforeTool, AfterTool, BeforeModel, etc.). Requires MessageBus integration.',
        showInDialog: false,
      },
    },
  },
...
> = {
  MCPServerConfig: {
    ...
    properties: {
      ...
      extension: {
        type: 'object',
        description:
          'Metadata describing the Ollama CLI extension that owns this MCP server.',
  ...
  TelemetrySettings: {
    type: 'object',
    description: 'Telemetry configuration for Ollama CLI.',
    additionalProperties: false,
    properties: {
      enabled: {
        type: 'boolean',
  ...
  CustomTheme: {
    type: 'object',
    description:
      'Custom theme definition used for styling Ollama CLI output. Colors are provided as hex strings or named ANSI colors.',
    additionalProperties: false,
    properties: {
      type: {
        type: 'string',
