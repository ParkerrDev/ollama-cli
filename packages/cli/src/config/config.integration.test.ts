...
import type { ConfigParameters } from '@google/ollama-cli-core';
import {
  Config,
...
vi.mock('@google/ollama-cli-core', async () => {
  const actual = await vi.importActual('@google/ollama-cli-core');
  return {
    ...actual,
...
describe('Configuration Integration Tests', () => {
  ...
  beforeEach(() => {
    ...
    tempDir = fs.mkdtempSync(path.join(tmpdir(), 'ollama-cli-test-'));
