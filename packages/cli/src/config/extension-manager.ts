...
export class ExtensionManager extends ExtensionLoader {
  ...
  private loadedExtensions: OllamaCLIExtension[] | undefined;
  ...
  async installOrUpdateExtension(
    ...
    let extension: OllamaCLIExtension | null;
    try {
   ...
   */
  async loadExtensions(): Promise<OllamaCLIExtension[]> {
    if (this.loadedExtensions) {
  ...
  private async loadExtension(
    extensionDir: string,
  ): Promise<OllamaCLIExtension | null> {
    this.loadedExtensions ??= [];
  ...
  toOutputString(extension: OllamaCLIExtension): string {
