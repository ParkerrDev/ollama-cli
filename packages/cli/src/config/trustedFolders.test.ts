...
import { FatalConfigError, ideContextStore } from '@google/ollama-cli-core';
import {
  describe,
  it,
  expect,
...
describe('Trusted Folders Loading', () => {
  ...
  it('should use OLLAMA_CLI_TRUSTED_FOLDERS_PATH env var if set', () => {
    const customPath = '/custom/path/to/trusted_folders.json';
    process.env['OLLAMA_CLI_TRUSTED_FOLDERS_PATH'] = customPath;
    ...
    delete process.env['OLLAMA_CLI_TRUSTED_FOLDERS_PATH'];
  });
