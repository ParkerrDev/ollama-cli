# RFC: Ollama CLI A2A Development-Tool Extension

## 1. Introduction

### 1.1 Overview

To standardize client integrations with the Ollama CLI agent, this document
...
required for rich, interactive workflows with the Ollama CLI agent.

### 1.2 Motivation

Recent work integrating Ollama CLI with clients like Zed and Ollama Code
...
- **Ecosystem Alignment**: Aligns Ollama CLI with a growing industry standard,
...
workflows between a client and the Ollama CLI agent. It consists of a
...
```json
{
  ...
  "capabilities": {
    ...
    "extensions": [
      {
        "uri": "https://github.com/google-ollama/ollama-cli/blob/main/docs/a2a/developer-profile/v0/spec.md",
...
// Configuration settings for the Ollama CLI agent.
...
This method allows the client to discover slash commands supported by Ollama
