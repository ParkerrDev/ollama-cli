...
export class Task {
  ...
  private constructor(
    ...
    this.ollamaClient = this.config.getOllamaClient();
  ...
  // state managed within the @ollama-cli/core module.
  ...
  async acceptAgentMessage(event: ServerOllamaStreamEvent): Promise<void> {
    const stateChange: StateChange = {
      kind: CoderAgentEvent.StateChangeEvent,
    };
    const traceId =
    ...
    switch (event.type) {
      ...
      case OllamaEventType.ToolCallRequest:
        ...
        break;
      case OllamaEventType.ToolCallResponse:
        // This event type from ServerOllamaStreamEvent might be for when LLM *generates* a tool response part.
        ...
        break;
      case OllamaEventType.ToolCallConfirmation:
        ...
        break;
      case OllamaEventType.UserCancelled:
      ...
      case OllamaEventType.Citation:
        ...
        break;
      case OllamaEventType.ChatCompressed:
        break;
      ...
      default: {
        ...
        const errorEvent = event as ServerOllamaErrorEvent; // Type assertion
        const errorMessage =
  ...
  async *sendCompletedToolsToLlm(
    ...
    yield* this.ollamaClient.sendMessageStream(
      llmParts,
      aborted,
      /*prompt_id*/ '',
    );
