...
import type { Config, Storage } from '@google/ollama-cli-core';
...
export function createMockConfig(
  ...
  const mockConfig = {
    ...
    getContentGeneratorConfig: vi.fn().mockReturnValue({ model: 'ollama-pro' }),
  ...
  mockConfig.getOllamaClient = vi
    .fn()
    .mockReturnValue(new OllamaClient(mockConfig));
  return mockConfig;
}
