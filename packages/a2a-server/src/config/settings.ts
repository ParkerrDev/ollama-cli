...
import type { MCPServerConfig } from '@google/ollama-cli-core';
import {
  debugLogger,
  OLLAMA_DIR,
  getErrorMessage,
...
export const USER_SETTINGS_DIR = path.join(homedir(), OLLAMA_DIR);
export const USER_SETTINGS_PATH = path.join(USER_SETTINGS_DIR, 'settings.json');

// Reconcile with https://github.com/google-ollama/ollama-cli/blob/b09bc6656080d4d12e1d06734aae2ec33af5c1ed/packages/cli/src/config/settings.ts#L53
 ...
 *
 * How is it different to ollama-cli/cli: Returns already merged settings rather
